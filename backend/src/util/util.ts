...
export function randomDoc() {

    const title = 'tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. ';
    ...
    return S9Document.createS9Document({
        createdAt: Date.now(),
        changedAt: Date.now(),
        title: title.substring(Math.floor((Math.random() * title.length))),
        body: body.substring(Math.floor((Math.random() * body.length))),
        author: 'e78b6237-cf9d-43fc-81ff-ef70bc3e512f',
        tags: ['test'],
        library: '',
        lastEditedBy: 'e78b6237-cf9d-43fc-81ff-ef70bc3e512f'
    });
}